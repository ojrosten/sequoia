...
namespace sequoia::maths::graph_impl
{
  ...
  {
    using edge_type = typename edge_type_generator<GraphFlavour, EdgeWeight, data_sharing::spawner<EdgeWeight>, IndexType, edge_sharing_preference::independent>::edge_type;
