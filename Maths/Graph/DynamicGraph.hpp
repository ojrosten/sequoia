...
{
  template<graph_flavour GraphFlavour, class EdgeWeight, template <class, template<class> class...> class EdgeWeightPooling>
  ...
  template<class NodeWeight, template <class, template<class> class...> class NodeWeightPooling, bool=std::is_empty_v<NodeWeight>>
  ...
  template<class NodeWeight, template <class, template<class> class...> class NodeWeightPooling>
  ...
  <
    ...
    class EdgeWeight,
    class NodeWeight,      
    template <class, template<class> class...> class EdgeWeightPooling=data_sharing::unpooled,
    template <class, template<class> class...> class NodeWeightPooling=data_sharing::unpooled,
    template<graph_flavour, class, template<class, template<class> class...> class> class EdgeStorageTraits = bucketed_edge_storage_traits,
    template<class, template<class, template<class> class...> class, bool> class NodeWeightStorageTraits = node_weight_storage_traits
  >
