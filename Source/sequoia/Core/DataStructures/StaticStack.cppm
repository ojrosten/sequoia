...
export module sequoia.core.data_structures:StaticStack;
  ...
  public:
    ...
    friend constexpr bool operator==(const static_stack& lhs, const static_stack& rhs) noexcept
    {
      return (lhs.m_End == rhs.m_End)
          && std::ranges::equal(lhs.m_Stack.begin(), lhs.m_Stack.begin() + lhs.m_End, rhs.m_Stack.begin(), rhs.m_Stack.begin() + rhs.m_End);
    }
  private:
