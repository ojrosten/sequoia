...
namespace sequoia::testing
{
  ...
  template<class T, invocable_exact_r<T, const T&> TransitionFn>
  ...
  template<class T, invocable_exact_r<T, const T&> TransitionFn, check_ordering=check_ordering{deep_totally_ordered<T>}>
  struct transition_info : transition_info_base<T, TransitionFn>
  {};

  template<deep_totally_ordered T, invocable_exact_r<T, const T&> TransitionFn>
