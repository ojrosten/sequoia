...
namespace sequoia::testing::impl
{
                                                      ...
                                                      const allocation_info<T, Getters>&... info)
  {
    ...
    using check_t = std::conditional_t<std::is_same_v<std::remove_cvref_t<T>, U>, simple_equality_check_t, with_best_available_check_t<minimal_reporting_permitted::yes>>;
