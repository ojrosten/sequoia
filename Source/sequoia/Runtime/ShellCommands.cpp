...
// Not standard-library headers, so import std supplies neither: the Win32 API through which
// Windows spawns the child, and on POSIX the macros that decode std::system's exit status.
#ifdef _WIN32
