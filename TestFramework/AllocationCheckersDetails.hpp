...
namespace sequoia::testing::impl
{
  ...
  static void check_allocation(std::string_view detail, test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, const basic_allocation_info<Container, Allocator, Predictions>& info, const int previous, const int prediction)
  {
  ...
  public:
    ...
    void check_no_allocation(std::string_view detail, test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& x, const Container& y) const
    {
    ...
    template<test_mode Mode>
    void check_copy_assign_y_to_x(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& xContainer, const Container& yContainer) const
    {
      ...
      if constexpr(propagate)
      {
        ...
        check_allocation("Unexpected allocation detected for copy assignment (x)", logger, sentry, xContainer, info(), second_count(), yPrediction);
      }
      else
      {
        const int xPrediction{info().get_predictions().assign_y_to_x.without_propagation};        
        check_allocation("Unexpected allocation detected for copy assignment (x)", logger, sentry, xContainer, info(), first_count(), xPrediction);
      }

      check_allocation("Unexpected allocation detected for copy assignment (y)", logger, sentry, yContainer, info(), second_count(), yPrediction);
    }

    template<test_mode Mode>
    void check_move_assign_y_to_x(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& xContainer) const
    {
      ...
      if constexpr(propagate)
      {
        check_allocation("Unexpected allocation detected for move assignment (x)", logger, sentry, xContainer, info(), second_count(), xPrediction);
      }
      else
      {
        check_allocation("Unexpected allocation detected for move assignment (x)", logger, sentry, xContainer, info(), first_count(), xPrediction);
      }
    }

    template<test_mode Mode>
    void check_mutation_after_swap(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& lhs, const Container& rhs) const
    {
  ...
  public:
    ...
    template<test_mode Mode>
    void check(std::string_view detail, test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, const int prediction) const
    {
  ...
  void check_no_allocation(std::string_view detail, test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& x, const Container& y, const dual_allocation_checker<Container, Allocator, Prediction>& checker, const dual_allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
  ...
  template<test_mode Mode, class Container, class Allocator, class Prediction, class... Allocators, class... Predictions>
  void check_copy_assign_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& xContainer, const Container& yContainer, const dual_allocation_checker<Container, Allocator, Prediction>& checker, const dual_allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
      [&logger, &sentry, &xContainer, &yContainer](const auto& checker){
        checker.check_copy_assign_y_to_x(logger, sentry, xContainer, yContainer);
      }
    };
  ...
  template<test_mode Mode, class Container, class Allocator, class Prediction, class... Allocators, class... Predictions>
  void check_move_assign_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& xContainer, const dual_allocation_checker<Container, Allocator, Prediction>& checker, const dual_allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
      [&logger, &sentry, &xContainer](const auto& checker){
        checker.check_move_assign_y_to_x(logger, sentry, xContainer);
      }
    };
  ...
  template<test_mode Mode, class Container, class Allocator, class Prediction, class... Allocators, class... Predictions>
  void check_mutation_after_swap(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& xContainer, const Container& yContainer, const dual_allocation_checker<Container, Allocator, Prediction>& checker, const dual_allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
      [&logger, &sentry, &xContainer, &yContainer](const auto& checker){
        checker.check_mutation_after_swap(logger, sentry, xContainer, yContainer);
      }
    };
  ...
  void check_mutation_after_swap(test_logger<Mode>& logger, const sentinel<Mode>& sentry, Container& lhs, const Container& rhs, const Container& y, Mutator yMutator, dual_allocation_checker<Container, Allocators, Predictions>... checkers)
  {
  ...
  template<test_mode Mode, class Container, class Allocator, class Prediction, class... Allocators, class... Predictions>
  void check_copy_x_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, const allocation_checker<Container, Allocator, Prediction>& checker, const allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
  ...
  template<test_mode Mode, class Container, class Allocator, class Prediction, class... Allocators, class... Predictions>
  void check_copy_y_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, const allocation_checker<Container, Allocator, Prediction>& checker, const allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
      [&logger, &sentry, &container](const auto& checker){
  ...
  template<test_mode Mode, class Container, class Allocator, class Prediction, class... Allocators, class... Predictions>
  void check_move_y_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, const allocation_checker<Container, Allocator, Prediction>& checker, const allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
      [&logger, &sentry, &container](const auto& checker){
  ...
  template<test_mode Mode, class Container, class Allocator, class Prediction, class... Allocators, class... Predictions>
  void check_mutation_allocation(std::string_view priorOp, test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& yContainer, const allocation_checker<Container, Allocator, Prediction>& checker, const allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
      [priorOp, &logger, &sentry, &yContainer](const auto& checker){
        ...
        checker.check(mess, logger, sentry, yContainer, prediction);
      }
    };
  ...
  template<test_mode Mode, class Container, class Allocator, class Prediction, class... Allocators, class... Predictions>
  void check_para_copy_y_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, const allocation_checker<Container, Allocator, Prediction>& checker, const allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
      [&logger, &sentry, &container](const auto& checker){
  ...
  void check_para_copy_y_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, std::tuple<allocation_checker<Container, Allocators, Predictions>...> checkers)
  {
  ...
  void check_para_move_y_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, const allocation_checker<Container, Allocator, Prediction>& checker, const allocation_checker<Container, Allocators, Predictions>&... moreCheckers)
  {
    auto checkFn{
      [&logger, &sentry, &container](const auto& checker){
  ...
  template<test_mode Mode, class Container, class... Allocators, class... Predictions>
  void check_para_move_y_allocation(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& container, std::tuple<allocation_checker<Container, Allocators, Predictions>...> checkers)
  {
    auto fn{[&logger, &sentry,&container](auto&&... checkers){
  ...
  struct allocation_actions : pre_condition_actions
  {
    ...
    template<test_mode Mode, class Container, class... Allocators, class... Predictions>
    static void post_move_action(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& y, const allocation_checker<Container, Allocators, Predictions>&... checkers)
    {
      check_move_y_allocation(logger, sentry, y, checkers...);
    }

    template<test_mode Mode, class Container, class Mutator, class... Allocators, class... Predictions>
    static void post_move_assign_action(test_logger<Mode>& logger, const sentinel<Mode>& sentry, Container& y, const Container& yClone, Mutator yMutator, const dual_allocation_checker<Container, Allocators, Predictions>&... checkers)
    {
    ...
    template<test_mode Mode, class Container, class... Allocators, class... Predictions>
    static void post_swap_action(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Container& x, const Container& y, const Container&, const dual_allocation_checker<Container, Allocators, Predictions>&... checkers)
    {
  ...
  bool check_preconditions(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Actions& actions, const Container& x, const Container& y, const dual_allocation_checker<Container, Allocators, Predictions>&... checkers)
  {
    return do_check_preconditions(logger, sentry, actions, x, y, dual_allocation_checker<Container, Allocators, Predictions>{checkers.info(), x, y}...);
  }

  template<test_mode Mode, class Actions, class Container, class... Allocators, class... Predictions>
  std::optional<Container> check_move_construction(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Actions& actions, Container&& z, const Container& y, const dual_allocation_checker<Container, Allocators, Predictions>&... checkers)
  {
    return do_check_move_construction(logger, sentry, actions, std::forward<Container>(z), y, allocation_checker{checkers.info(), z}...);
  }

  template<test_mode Mode, class Actions, class Container, class Mutator, class... Allocators, class... Predictions>
  void check_move_assign(test_logger<Mode>& logger, const sentinel<Mode>& sentry, const Actions& actions, Container& u, Container&& v, const Container& y, Mutator yMutator, const dual_allocation_checker<Container, Allocators, Predictions>&... checkers)
  {
    do_check_move_assign(logger, sentry, actions, u, std::forward<Container>(v), y, std::move(yMutator), dual_allocation_checker{checkers.info(), u, v}...);
  }

  template<test_mode Mode, class Container, class Mutator, class... Checkers>
  void check_mutation_after_move(std::string_view moveType, test_logger<Mode>& logger, const sentinel<Mode>& sentry, Container& u, const Container& y, Mutator yMutator, Checkers... checkers)
  {
    yMutator(u);
  ...
  void check_mutation_after_move(std::string_view moveType, test_logger<Mode>& logger, const sentinel<Mode>& sentry, Container& u, const Container& y, Mutator yMutator, std::tuple<Checkers...> checkers, std::index_sequence<I...>)
  {
    check_mutation_after_move(moveType, logger, sentry, u, y, std::move(yMutator), std::get<I>(checkers)...);
  }

  template<test_mode Mode, class Container, class Mutator, class... Checkers>
  void check_mutation_after_move(std::string_view moveType, test_logger<Mode>& logger, const sentinel<Mode>& sentry, Container& u, const Container& y, Mutator yMutator, std::tuple<Checkers...> checkers)
  {
