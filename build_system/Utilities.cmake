...
FUNCTION(sequoia_set_warnings target)
    if (MSVC)
        ...
        if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
            target_compile_options(${target} PUBLIC -Wno-missing-braces -Wno-braced-scalar-init -Wno-unused-function)
        elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
            target_compile_options(${target} PUBLIC -Wno-comment)
        endif()
    endif()
ENDFUNCTION()
