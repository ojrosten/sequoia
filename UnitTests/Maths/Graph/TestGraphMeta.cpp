...
{  
  ...
  void test_graph_meta::test_undirected_unshared()
  {
    ...
    using gen_t = edge_traits<GraphFlavour, EdgeWeight, EdgeWeightStorage, contiguous_storage, std::size_t>;
  ...
  void test_graph_meta::test_directed_impl()
  {
    ...
    using gen_t = edge_traits<graph_flavour::directed, EdgeWeight, EdgeWeightStorage, contiguous_storage, std::size_t>;
    using edge_t = typename gen_t::edge_type;
    using proxy = typename EdgeWeightStorage<EdgeWeight>::proxy;
  ...
  void test_graph_meta::test_directed_embedded_impl()
  {
    ...
    using gen_t = edge_traits<graph_flavour::directed_embedded, EdgeWeight, EdgeWeightStorage, contiguous_storage, std::size_t>;
    using edge_t = typename gen_t::edge_type;
    using proxy = typename EdgeWeightStorage<EdgeWeight>::proxy;
