...
namespace sequoia::unit_testing
{
  ...
  void test_heterogeneous_static_graph::test_generic_undirected()
  {
...

    {
      ...
      check_equality(4, g.node_weight<0>()(2), LINE(""));
    }
  }
  ...
  void test_heterogeneous_static_graph::test_generic_embedded_undirected()
  {
    ...
    
    {
      ...
      check_graph(g, {{edge{1, 0, 0.5f}}, {edge{0, 0, 0.5f}}}, std::tuple<int, double>{0, 0.0}, LINE(""));
    }

    {
      constexpr auto g{make_undirected_embedded_graph()};
      using edge = typename decltype(g)::edge_init_type;
      check_graph(g, {{edge{1, 0, -0.3f}}, {edge{0, 0, -0.3f}}, {}}, std::tuple<float, int, double>{9.9f, -6, 11.2}, LINE(""));
    }
  }
  ...
  void test_heterogeneous_static_graph::test_generic_embedded_directed()
  {
...

    {
      ...
      check_graph(g, {{edge{0, 1, 0, 0.5f}}, {edge{0, 1, 0, 0.5f}}}, std::tuple<int, double>{0, 0.0}, LINE(""));
    }

    {
      constexpr auto g{make_directed_embedded_graph()};
      using edge = typename decltype(g)::edge_init_type;
      check_graph(g, {{edge{0, 1, 0, -0.3f}}, {edge{0, 1, 0, -0.3f}}, {}}, std::tuple<float, int, double>{9.9f, -6, 11.2}, LINE(""));
    }
  }
}
