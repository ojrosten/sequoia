...
namespace sequoia::testing
{
  ...
  [[nodiscard]]
  std::filesystem::path bucketed_sequence_allocation_test::source_file()
  {
  ...
  void bucketed_sequence_allocation_test::test_bucketed_allocation()
  {
    ...
    using storage    = custom_bucketed_sequence_generator<T, PropagateCopy, PropagateMove, PropagateSwap>::storage_type;
