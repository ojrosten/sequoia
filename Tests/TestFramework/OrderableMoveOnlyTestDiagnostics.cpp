...
{
  [[nodiscard]]
  std::filesystem::path orderable_move_only_false_negative_diagnostics::source_file()
  {
  ...
  [[nodiscard]]
  std::filesystem::path orderable_move_only_false_positive_diagnostics::source_file()
  {
    return std::source_location::current().file_name();
  }
