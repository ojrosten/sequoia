...
namespace sequoia::testing
{
  ...
  [[nodiscard]]
  std::filesystem::path scoped_allocation_false_positive_diagnostics::source_file()
  {
  ...
  void scoped_allocation_false_positive_diagnostics::test_perfectly_branched()
  {
    ...
    using inner_t = std::tuple<inner_beast, inner_beast>;

    using outer_allocator = shared_counting_allocator<inner_t, PropagateCopy, PropagateMove, PropagateSwap>;
    using beast = perfectly_normal_beast<inner_t, std::scoped_allocator_adaptor<outer_allocator, inner_allocator>>;
