...
namespace sequoia::testing
{
  ...
  void move_only_scoped_allocation_false_negative_diagnostics::test_regular_semantics()
  {
    ...
    check(equality, report("check_semantics return value (y)"), y, beast{{"something too long for small string optimization"}});
  }
  ...
  void move_only_scoped_allocation_false_positive_diagnostics::test_regular_semantics()
  {
    ...
    {
      check_semantics(report("Incorrect assigment outer allocs"),
                      beast{},
                      beast{{"something too long for small string optimization"}},
                      beast{},
                      beast{{"something too long for small string optimization"}},
    ...
    check_semantics(report("Incorrect mutation outer allocs"),
                    beast{},
                    beast{{"something too long for small string optimization"}},
                    beast{},
                    beast{{"something too long for small string optimization"}},
    ...
    check_semantics(report("Incorrect para move outer allocs"),
                    beast{},
                    beast{{"something too long for small string optimization"}},
                    beast{},
                    beast{{"something too long for small string optimization"}},
    ...
    if constexpr(!PropagateMove)
    {
      check_semantics(report("Incorrect assigment inner allocs"),
                      beast{},
                      beast{{"something too long for small string optimization"}},
                      beast{},
                      beast{{"something too long for small string optimization"}},
    ...
    check_semantics(report("Incorrect mutation inner allocs"),
                    beast{},
                    beast{{"something too long for small string optimization"}},
                    beast{},
                    beast{{"something too long for small string optimization"}},
    ...
    check_semantics(report("Incorrect para move inner allocs"),
                    beast{},
                    beast{{"something too long for small string optimization"}},
                    beast{},
                    beast{{"something too long for small string optimization"}},
