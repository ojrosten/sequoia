...
{
  [[nodiscard]]
  std::filesystem::path move_only_allocation_false_negative_diagnostics::source_file()
  {
  ...
  void move_only_allocation_false_negative_diagnostics::test_move_only_semantics_allocations()
  {
...

    {
      ...
      check_semantics("Incorrect para-move allocs, as unique", beast{}, beast{2}, equivalent_t{}, equivalent_t{2}, mutator,
                      allocation_info{allocGetter, {0_pm, {0_pm, 1_mu}, {1_manp}}});
  ...
  [[nodiscard]]
  std::filesystem::path move_only_allocation_false_positive_diagnostics::source_file()
  {
    return std::source_location::current().file_name();
  }
  ...
  void move_only_allocation_false_positive_diagnostics::test_move_only_semantics_allocations()
  {
...

    {
      ...
      check_semantics("Move-only beast, as unique", beast{1}, beast{2}, equivalent_t{1}, equivalent_t{2}, mutator,
                      allocation_info{allocGetter, {1_pm, {1_pm, 1_mu}, {0_manp}}});
...

    {
      ...
      check_semantics("Check moved-from state, as unique", beast{1}, beast{2}, equivalent_t{1}, equivalent_t{2}, equivalent_t{}, equivalent_t{},  mutator,
        allocation_info{allocGetter, {1_pm, {1_pm, 1_mu}, {0_manp}}});
