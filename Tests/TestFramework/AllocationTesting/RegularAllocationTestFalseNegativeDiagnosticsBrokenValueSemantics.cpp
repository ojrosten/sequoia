...
{
  [[nodiscard]]
  std::filesystem::path allocation_false_negative_diagnostics_broken_value_semantics::source_file() const
  {
    return std::source_location::current().file_name();
  }

  void allocation_false_negative_diagnostics_broken_value_semantics::run_tests()
  {
    do_allocation_tests();
  }

  template<bool PropagateCopy, bool PropagateMove, bool PropagateSwap>
  void allocation_false_negative_diagnostics_broken_value_semantics::test_allocation()
  {
    test_regular_semantics<PropagateCopy, PropagateMove, PropagateSwap>();
  }

  template<bool PropagateCopy, bool PropagateMove, bool PropagateSwap>
  void allocation_false_negative_diagnostics_broken_value_semantics::test_regular_semantics()
  {
