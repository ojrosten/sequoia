...
#include "../Maths/Graph/Directed/DynamicDirectedGraphTestingUtilities.hpp"

#include "sequoia/TestFramework/RegularTestCore.hpp"
#include "sequoia/TestFramework/StateTransitionUtilities.hpp"

namespace sequoia::testing::temp
{
...
namespace sequoia::testing
{
  ...
  void experimental_test::run_tests()
  {
    ...
    temp::dynamic_directed_graph_operations<double, double, independent_contiguous_edge_storage_traits, node_weight_storage_traits<double>>::execute_operations(*this);
  }
}
