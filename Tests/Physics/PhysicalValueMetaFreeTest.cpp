...
namespace sequoia::testing
{
  ...
  void physical_value_meta_free_test::test_count_and_combine()
  {
    ...
    STATIC_CHECK(std::is_same_v<count_and_combine_t<direct_product<dual<mass_space_t>, euc_vec_space_t>>,
                                direct_product<type_counter<euc_vec_space_t, 1>, type_counter<dual<mass_space_t>, 1>>>);

    STATIC_CHECK(std::is_same_v<count_and_combine_t<direct_product<euc_vec_space_t, dual<delta_mass_space_t>>>,
                                direct_product<type_counter<dual<delta_mass_space_t>, 1>, type_counter<euc_vec_space_t, 1>>>);

    STATIC_CHECK(std::is_same_v<count_and_combine_t<direct_product<dual<delta_mass_space_t>, euc_vec_space_t>>,
                                direct_product<type_counter<euc_vec_space_t, 1>, type_counter<dual<delta_mass_space_t>, 1>>>);
  }
  ...
  void physical_value_meta_free_test::test_reduce()
  {
    ...
    STATIC_CHECK(std::is_same_v<reduce_t<count_and_combine_t<direct_product<mass_space_t, dual<mass_space_t>>>>,
                                direct_product<euclidean_half_line<implicit_common_arena>>>);

    STATIC_CHECK(std::is_same_v<reduce_t<count_and_combine_t<direct_product<mass_space_t, dual<delta_mass_space_t>>>>,
                                direct_product<euclidean_vector_space<1, implicit_common_arena>>>);
    ...
    STATIC_CHECK(
      std::is_same_v<
        reduce_t<count_and_combine_t<direct_product<euc_vec_space_t, dual<euc_vec_space_t>>>>,
        direct_product<euc_vec_space_t>
      >,
    ...
    STATIC_CHECK(
      std::is_same_v<
        reduce_t<count_and_combine_t<direct_product<euc_half_space_t, dual<euc_half_space_t>>>>,
        direct_product<euc_half_space_t>
      >,
      "count_and_combine assumes ordering T, deltaT, dual<T>, dual<deltaT>"
    );
    ...
    STATIC_CHECK(std::is_same_v<reduce_t<count_and_combine_t<direct_product<dual<euc_half_space_t>, euc_vec_space_t>>>,
                                direct_product<euc_vec_space_t>>);

    STATIC_CHECK(std::is_same_v<reduce_t<count_and_combine_t<direct_product<dual<euc_half_space_t>, dual<euc_vec_space_t>>>>,
                                direct_product<euc_vec_space_t>>);
  }
