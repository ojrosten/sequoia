...
{ 
  ...
  void mixed_physical_value_test::test_mixed()
  {
    ...
    using unsafe_mass_t = unsafe_quantity<  mass_space<float, implicit_common_arena>, kilogram_t, std::identity>;
    using unsafe_len_t  = unsafe_quantity<length_space<float, implicit_common_arena>, metre_t,    std::identity>;
