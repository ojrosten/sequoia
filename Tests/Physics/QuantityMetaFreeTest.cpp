...
namespace sequoia::testing
{
  ...
  void quantity_meta_free_test::run_tests()
  {
    ...
    //STATIC_CHECK((std::is_same_v<reduction_t<std::tuple<units::kelvin_t, dual<units::kelvin_t>>>, no_unit>), "");
    ...
    STATIC_CHECK((std::is_same_v<reduce_t<counter_t<std::tuple<mass_space_t, dual<mass_space_t>>>>,  std::tuple<euclidean_vector_space<1, float>>>), "");
    ...
    STATIC_CHECK((std::is_same_v<reduce_t<counter_t<std::tuple<units::kilogram_t, dual<units::kilogram_t>>>>,  no_unit>), "");
  }
}
