  ...
  {
    {
      ...
      using coords_t = vector_coordinates<my_vec_space<sets::R<1>, commutative_rings::reals<1>, 1>, basis_t, canonical_representation<float, no_bounds<float>>, identity_validator>;
      test_vec_1<coords_t>();
    }
