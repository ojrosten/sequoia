...
namespace sequoia::testing
{
  ...
  void vector_coordinates_test::test_vec()
  {
    ...
    using vec_t       = vector_coordinates<vec_space_t, basis_t, identity_representation<no_bounds<to_bounds_value_type_t<Field>>>>;
    using value_t     = Field;
  ...
  void vector_coordinates_test::test_real_vec_1_inner_prod()
  {
    ...
    using vec_t   = vector_coordinates<my_vec_space<Set, Field, 1>, basis_t, identity_representation<no_bounds<to_bounds_value_type_t<Field>>>>;
