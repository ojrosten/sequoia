...
namespace sequoia::testing
{
  ...
  void affine_coordinates_test::test_affine()
  {
    ...
    using affine_t = affine_coordinates<space_t, basis_t, alice<space_t>, identity_representation<no_bounds<to_bounds_value_type_t<Field>>>>;
    ...
    using affine2_t = affine_coordinates<space_t, basis_t, bob<space_t>, identity_representation<no_bounds<to_bounds_value_type_t<Field>>>>;
