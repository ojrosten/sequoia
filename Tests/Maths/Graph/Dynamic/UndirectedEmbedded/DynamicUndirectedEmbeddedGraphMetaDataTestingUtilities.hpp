...
namespace sequoia::testing
{
  namespace undirected_embedded_graph{
    // Convention: the indices following 'md_node' - separated by underscores - give the target md_node of the associated edges
  ...
  class dynamic_undirected_embedded_graph_meta_data_operations
  {
   public:
    ...
    static void check_initialization_exceptions(regular_test& t)
    {
      ...
      // One md_node
      t.check_exception_thrown<std::out_of_range>("Target index of edge out of range", [](){ return graph_type{{{1, 0, 0.5f}}}; });
      t.check_exception_thrown<std::out_of_range>("Complimentary index of edge out of range", [](){ return graph_type{{{0, 1, 0.5f}}}; });
      t.check_exception_thrown<std::logic_error>("Self-referential complimentary index", [](){ return graph_type{{{0, 0, 0.5f}}}; });
      t.check_exception_thrown<std::logic_error>("Mismatched complimentary indices", [](){ return graph_type{{{0, 1, 0.5f}, {0, 1, 0.5f}}}; });
      t.check_exception_thrown<std::logic_error>("Mismatched complimentary indices", [](){ return graph_type{{{0, 1, 0.5f}, {0, 2, 0.5f}, {0, 0, 0.5f}}}; });

      // Two nodes
      t.check_exception_thrown<std::logic_error>("Mismatched complimentary indices", [](){ return graph_type{{{1, 0, 0.5f}, {0, 2, 0.5f}, {0, 1, 0.5f}}, {{0, 1, 0.5f}}}; });
    }
      ...
      return transition_graph{
        {
          ...
          {  // begin 'meta_data_graph_description::md_node_node'
            {
              meta_data_graph_description::md_node_1b_node_0a,
              t.report("Join {0,1}"),
              [](graph_type g) -> graph_type {
          ...
          }, // end 'meta_data_graph_description::md_node_node'
          {  // begin 'meta_data_graph_description::md_node_1b_node_0a'
          }  // end 'meta_data_graph_description::md_node_1b_node_0a'
        },
        {
          //  'md_empty'
