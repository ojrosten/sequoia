...
namespace sequoia::testing
{
  ...
  void dynamic_undirected_embedded_graph_shared_fundamental_weight_contiguous_test::run_tests()
  {
    ...
    dynamic_undirected_embedded_graph_weighted_operations<double, double, shared_weight_contiguous_edge_storage_config, node_storage<double>>::execute_operations(*this);
  }
}