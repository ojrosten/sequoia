...
#include "DynamicDirectedEmbeddedGraphFaithfulFaithfulSharedEdgeTest.hpp"

namespace sequoia::testing
{

  [[nodiscard]]
  std::filesystem::path dynamic_directed_embedded_graph_faithful_faithful_shared_edge_test::source_file() const
  {
    return std::source_location::current().file_name();
  }

  void dynamic_directed_embedded_graph_faithful_faithful_shared_edge_test::run_tests()
  {
