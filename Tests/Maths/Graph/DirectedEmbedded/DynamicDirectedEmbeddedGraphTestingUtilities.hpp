...
namespace sequoia::testing
{
  ...
  >
  class dynamic_directed_embedded_graph_operations
  {
  ...
  public:
    ...
    {
      graph_t g{init};
      t.check(weak_equivalence, description, g, init);
      return g;
    }
    ...
    static transition_graph make_transition_graph(regular_test& t)
    {
       ...
       { // begin, 'empty'
        ...
        {  // begin 'node'
          ...
          },
          {
            ...
            t.report_line("Add inverted loop"),
            [](graph_t g) -> graph_t {
        ...
        {  // begin 'node_0'
          ...
          },
          {
            ...
            t.report_line("Interleave an inverted second loop"),
            [](graph_t g) -> graph_t {
        ...
        {  // begin 'node_0inv',
          ...
          {
            graph_description::node,
            t.report_line("Remove loop via first insertion"),
            [](graph_t g) -> graph_t {
              g.erase_edge(g.cbegin_edges(0));
              return g;
            }
          ...
          {
            graph_description::node,
            t.report_line("Remove loop via second insertion"),
            [](graph_t g) -> graph_t {
              g.erase_edge(++g.cbegin_edges(0));
              return g;
            }
          },
          {
            ...
            t.report_line("Add second inverted loop"),
            [](graph_t g) -> graph_t {
          ...
          },
          {
            ...
            t.report_line("Interleave second inverted loop"),
            [](graph_t g) -> graph_t {
              g.insert_join(g.cbegin_edges(0) + 2, 1);
              return g;
            }
        ...
        {  // begin node_node_0
          ...
          },
          {
            ...
            t.report_line("Insert Join nodes {0,1}"),
            [](graph_t g) {
      ...
      },
      {
        ...
        //  'node_0'
        make_and_check(t, t.report_line(""), {{edge_t{0, 0, 1}, edge_t{0, 0, 0}}}),

        //  'node_0_0'
        make_and_check(t, t.report_line(""), {{edge_t{0, 0, 1}, edge_t{0, 0, 0}, edge_t{0, 0, 3}, edge_t{0, 0, 2}}}),

        // 'node_0_0_interleaved'
        make_and_check(t, t.report_line(""), {{edge_t{0, 0, 2}, edge_t{0, 0, 3}, edge_t{0, 0, 0}, edge_t{0, 0, 1}}}),

        //  'node_0inv'
        make_and_check(t, t.report_line(""), {{edge_t{0, inverted_edge, 1}, edge_t{0, inverted_edge, 0}}}),

        //  'node_0inv_0inv'
        make_and_check(t, t.report_line(""), {{edge_t{0, inverted_edge, 1}, edge_t{0, inverted_edge, 0}, edge_t{0, inverted_edge, 3}, edge_t{0, inverted_edge, 2}}}),

        // 'node_0inv_0inv_interleaved'
        make_and_check(t, t.report_line(""), {{edge_t{0, inverted_edge, 2}, edge_t{0, inverted_edge, 3}, edge_t{0, inverted_edge, 0}, edge_t{0, inverted_edge, 1}}}),

        // 'node_0_0inv_interleaved'
        make_and_check(t, t.report_line(""), {{edge_t{0, 0, 2}, edge_t{0, inverted_edge, 3}, edge_t{0, 0, 0}, edge_t{0, inverted_edge, 1}}}),

        // 'node_0inv_0_0inv_interleaved'
        make_and_check(t, t.report_line(""), {{edge_t{0, inverted_edge, 1}, edge_t{0, inverted_edge, 0}, edge_t{0, 0, 4}, edge_t{0, inverted_edge, 5}, edge_t{0, 0, 2}, edge_t{0, inverted_edge, 3}}}),

        //  'node_node'
        make_and_check(t, t.report_line(""), {{}, {}}),

        //  'node_1_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}}, {edge_t{0, 1, 0}}}),

        //  'node_node_0'
        make_and_check(t, t.report_line(""), {{edge_t{1, 0, 0}}, {edge_t{1, 0, 0}}}),

        //  'node_0_1_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 0, 1}, edge_t{0, 0, 0}, edge_t{0, 1, 0}}, {edge_t{0, 1, 2}}}),

        //  'node_0_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 0, 1}, edge_t{0, 0, 0}}, {}}),

        //  'node_node_1'
        make_and_check(t, t.report_line(""), {{}, {edge_t{1, 1, 1}, edge_t{1, 1, 0}}}),

        // 'node_node_1_1inv_interleaved'
        make_and_check(t, t.report_line(""), {{}, {edge_t{1, 1, 2}, edge_t{1, inverted_edge, 3}, edge_t{1, 1, 0}, edge_t{1, inverted_edge, 1}}}),

        // 'node_node_1inv_1_1inv_interleaved'
        make_and_check(t, t.report_line(""), {{}, {edge_t{1, inverted_edge, 1}, edge_t{1, inverted_edge, 0}, edge_t{1, 1, 4}, edge_t{1, inverted_edge, 5}, edge_t{1, 1, 2}, edge_t{1, inverted_edge, 3}}}),

        // 'node_1_node_1inv_1_1inv_interleaved'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 4}},
        ...
        // 'node_1_node_1inv_1_0_1inv_interleaved'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 4}, edge_t{1, 0, 6}},
        ...
        // 'node_1_1_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}, edge_t{0, 1, 1}}, {edge_t{0, 1, 0}, edge_t{0, 1, 1}}}),

        // 'node_1_node_0'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}, edge_t{1, 0, 1}}, {edge_t{0, 1, 0}, edge_t{1, 0, 1}}}),

        // 'node_1pos1_node_0pos1'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 1}, edge_t{1, 0, 0}}, {edge_t{1, 0, 1}, edge_t{0, 1, 0}}}),
        ...
        //  'node_node_node_1'
        make_and_check(t, t.report_line(""), {{}, {edge_t{2, 1, 0}}, {edge_t{2, 1, 0}}}),

        // 'node_1_node_2_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}}, {edge_t{0, 1, 0}, edge_t{1, 2, 0}}, {edge_t{1, 2, 1}}}),

        // 'node_1_node_node_1'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}}, {edge_t{0, 1, 0}, edge_t{2, 1, 0}}, {edge_t{2, 1, 1}}}),

        // 'node_1_node_2_node_0'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}, edge_t{2, 0, 1}},
                                         {edge_t{0, 1, 0}, edge_t{1, 2, 0}},
                                         {edge_t{1, 2, 1}, edge_t{2, 0, 1}}}),

        // 'node_node_1_node'
        make_and_check(t, t.report_line(""), {{}, {edge_t{1, 1, 1}, edge_t{1, 1, 0}}, {}}),

        // 'node_1_node_1_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}}, {edge_t{0, 1, 0}, edge_t{1, 1, 2}, edge_t{1, 1, 1}}, {}}),

        // 'node_1_node_1_0_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}, edge_t{1, 0, 3}},
                                         {edge_t{0, 1, 0}, edge_t{1, 1, 2}, edge_t{1, 1, 1}, edge_t{1, 0, 1}},
                                         {}}),

        // 'node_1_node_1_0_2_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}, edge_t{1, 0, 3}},
                                         {edge_t{0, 1, 0}, edge_t{1, 1, 2}, edge_t{1, 1, 1}, edge_t{1, 0, 1}, edge_t{1, 2, 0}},
                                         {edge_t{1, 2, 4}}}),

        // 'node_1_node_1_2_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}},
                                         {edge_t{0, 1, 0}, edge_t{1, 1, 2}, edge_t{1, 1, 1}, edge_t{1, 2, 0}},
                                         {edge_t{1, 2, 3}}}),

        // 'node_2_node_node_2'
        make_and_check(t, t.report_line(""), {{edge_t{0, 2, 0}}, {}, {edge_t{0, 2, 0}, edge_t{2, 2, 2}, edge_t{2, 2, 1}}}),

        // 'node_1_1_2_2_node_2_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}, edge_t{0, 1, 2}, edge_t{0, 2, 0}, edge_t{0, 2, 2}},
                                         {edge_t{0, 1, 0}, edge_t{1, 2, 1}, edge_t{0, 1, 1}},
                                         {edge_t{0, 2, 2}, edge_t{1, 2, 1}, edge_t{0, 2, 3}}}),

        // 'node_1_1_2_2_node_2_node_1'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}, edge_t{0, 1, 3}, edge_t{0, 2, 0}, edge_t{0, 2, 3}},
                                         {edge_t{0, 1, 0}, edge_t{1, 2, 2}, edge_t{2, 1, 1}, edge_t{0, 1, 1}},
                                         {edge_t{0, 2, 2}, edge_t{2, 1, 2}, edge_t{1, 2, 1}, edge_t{0, 2, 3}}}),

        // node_2_2_1_1_node_2_node_1
        make_and_check(t, t.report_line(""), {{edge_t{0, 2, 0}, edge_t{0, 2, 3}, edge_t{0, 1, 0}, edge_t{0, 1, 3}},
                                         {edge_t{0, 1, 2}, edge_t{1, 2, 2}, edge_t{2, 1, 1}, edge_t{0, 1, 3}},
                                         {edge_t{0, 2, 0}, edge_t{2, 1, 2}, edge_t{1, 2, 1}, edge_t{0, 2, 1}}}),

        // 'node_3_1_node_2_node_node'
        make_and_check(t, t.report_line(""), {{edge_t{0, 3, 0},edge_t{0, 1, 0}},
                                         {edge_t{0, 1, 1}, edge_t{1, 2, 0}},
                                         {edge_t{1, 2, 1}},
                                         {edge_t{0, 3, 0}}}),

        // 'node_1_node_node_node_2'
        make_and_check(t, t.report_line(""), {{edge_t{0, 1, 0}}, {edge_t{0, 1, 0}}, {edge_t{3, 2, 0}}, {edge_t{3, 2, 0}}}),

        // 'node_2_node_node_node_1'
        make_and_check(t, t.report_line(""), {{edge_t{0, 2, 0}}, {edge_t{3, 1, 0}}, {edge_t{0, 2, 0}}, {edge_t{3, 1, 0}}})
      }
      };
    }
  };
