  ...
  namespace testing
  {
    ...
    void test_edges::test_plain_embedded_partial_edge()
    {
      ...
      using compact_edge_t
        = embedded_partial_edge<null_weight, independent, utilities::uniform_wrapper<null_weight>, unsigned char>;
    ...
    void test_edges::test_weighted_edge()
    {
      ...
      {
        using std::vector;
        using edge_t = edge<vector<int>, utilities::uniform_wrapper<vector<int>>>;
    ...
    void test_edges::test_plain_embedded_edge()
    {
      ...
      using compact_edge_t = embedded_edge<null_weight, independent, utilities::uniform_wrapper<null_weight>, unsigned char>;
