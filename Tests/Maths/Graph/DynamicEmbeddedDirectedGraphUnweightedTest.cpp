  ...
  void dynamic_embedded_directed_graph_unweighted_test::execute_operations()
  {
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        //  'node_0_1_node'
        make_and_check(report_line(""), {{edge_t{0, 0, 1}, edge_t{0, 0, 0}, edge_t{0, 1, 0}}, {edge_t{0, 1, 2}}}),
        ...
        //  'node_node_node_1'
        make_and_check(report_line(""), {{}, {edge_t{2, 1, 0}}, {edge_t{2, 1, 0}}}),

        // 'node_1_node_2_node'
        make_and_check(report_line(""), {{edge_t{0, 1, 0}}, {edge_t{0, 1, 0}, edge_t{1, 2, 0}}, {edge_t{1, 2, 1}}}),

        // 'node_1_node_node_1'
        make_and_check(report_line(""), {{edge_t{0, 1, 0}}, {edge_t{0, 1, 0}, edge_t{2, 1, 0}}, {edge_t{2, 1, 1}}}),

        // 'node_1_node_2_node_0'
        make_and_check(report_line(""), {{edge_t{0, 1, 0}, edge_t{2, 0, 1}},
        ...
        // 'node_1_node_1_2_node'
        make_and_check(report_line(""), {{edge_t{0, 1, 0}},
                                         {edge_t{0, 1, 0}, edge_t{1, 1, 2}, edge_t{1, 1, 1}, edge_t{1, 2, 0}},
                                         {edge_t{1, 2, 3}}}),

        // 'node_2_node_node_2'
        make_and_check(report_line(""), {{edge_t{0, 2, 0}}, {}, {edge_t{0, 2, 0}, edge_t{2, 2, 2}, edge_t{2, 2, 1}}}),

        // 'node_1_1_2_2_node_2_node'
        make_and_check(report_line(""), {{edge_t{0, 1, 0}, edge_t{0, 1, 2}, edge_t{0, 2, 0}, edge_t{0, 2, 2}},
                                         {edge_t{0, 1, 0}, edge_t{1, 2, 1}, edge_t{0, 1, 1}},
                                         {edge_t{0, 2, 2}, edge_t{1, 2, 1}, edge_t{0, 2, 3}}}),

        // 'node_1_1_2_2_node_2_node_1'
        make_and_check(report_line(""), {{edge_t{0, 1, 0}, edge_t{0, 1, 3}, edge_t{0, 2, 0}, edge_t{0, 2, 3}},
        ...
        make_and_check(report_line(""), {{edge_t{0, 2, 0}, edge_t{0, 2, 3}, edge_t{0, 1, 0}, edge_t{0, 1, 3}},
                                         {edge_t{0, 1, 2}, edge_t{1, 2, 2}, edge_t{2, 1, 1}, edge_t{0, 1, 3}},
                                         {edge_t{0, 2, 0}, edge_t{2, 1, 2}, edge_t{1, 2, 1}, edge_t{0, 2, 1}}}),

        // 'node_3_1_node_2_node_node'
        make_and_check(report_line(""), {{edge_t{0, 3, 0},edge_t{0, 1, 0}},
                                         {edge_t{0, 1, 1}, edge_t{1, 2, 0}},
                                         {edge_t{1, 2, 1}},
                                         {edge_t{0, 3, 0}}}),

        // 'node_1_node_node_node_2'
        make_and_check(report_line(""), {{edge_t{0, 1, 0}}, {edge_t{0, 1, 0}}, {edge_t{3, 2, 0}}, {edge_t{3, 2, 0}}}),

        // 'node_2_node_node_node_1'
        make_and_check(report_line(""), {{edge_t{0, 2, 0}}, {edge_t{3, 1, 0}}, {edge_t{0, 2, 0}}, {edge_t{3, 1, 0}}})
      }
    };
