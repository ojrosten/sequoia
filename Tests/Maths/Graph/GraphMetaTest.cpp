...
namespace sequoia::testing
{
  ...
  void test_graph_meta::test_undirected_unshared()
  {
    ...
    using gen_t = dynamic_edge_traits<GraphFlavour, EdgeWeight, EdgeMetaData, contiguous_edge_storage_config, std::size_t>;
  ...
  void test_graph_meta::test_directed_impl()
  {
    ...
    using gen_t = dynamic_edge_traits<graph_flavour::directed, EdgeWeight, null_meta_data, contiguous_edge_storage_config, std::size_t>;
    using edge_t       = typename gen_t::edge_type;
    using handler_type = shared_to_handler_t<false, EdgeWeight>;
