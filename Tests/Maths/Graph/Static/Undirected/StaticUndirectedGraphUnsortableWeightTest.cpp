...
namespace sequoia::testing
{
  ...
  void static_undirected_graph_unsortable_weight_test::test_node_0()
  {
    ...
    check_exception_thrown<std::logic_error>(report_line(""), [](){ graph_t{{edge_t{0, 0.3f, 0.1f}, edge_t{0, 0.3f, 0.2f}}}; });
    ...
    transition_graph trg{
      ...
      },
      {
         ...
         [this]() -> graph_t {
           ...
           check(equivalence, report_line(""), g, edges_init_t{{edge_t{2, 0.5f}, edge_t{1, -0.2f, 0.1f}}, {edge_t{2}, edge_t{0, -0.2f, 0.1f}}, {edge_t{1}, edge_t{0, 0.5f}}}, nodes_init_t{{}, {0.7}, {2.1, 1.1}});
