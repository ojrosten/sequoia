...
namespace sequoia::testing
{
    ...
    transition_graph trg{
      {
        { // begin 'graph_description::node'
          ...
          },
          {
            ...
            report_line(""),
            [this](graph_t g) -> graph_t {
              check(equality, report(""), g.mutate_node_weight(g.cbegin_node_weights(), [](auto& w) { w +=  std::complex<double>{2.1, 1.1}; return 42; }), 42);
              return g;
            }
          },
          {
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{}}, nodes_init_t{{2.1, 1.1}});
          check(equality, report(""), g, graph_t{edges_init_t{{}},  nodes_init_t{{2.1, 1.1}}});
  ...
  void static_undirected_graph_unsortable_weight_test::test_node_0()
  {
    ...
    check_exception_thrown<std::logic_error>(report(""), [](){ graph_t{{edge_t{0}}}; });
    check_exception_thrown<std::logic_error>(report(""), [](){ graph_t{{edge_t{0, 0.3f}, edge_t{0, 0.31f}}}; });
    check_exception_thrown<std::logic_error>(report(""), [](){ graph_t{{edge_t{0, 0.3f, 0.1f}, edge_t{0, 0.3f, 0.2f}}}; });
    ...
    transition_graph trg{
        ...
        { // begin 'graph_description::node_0'
          {
            ...
            report_line(""),
            [this](graph_t g) -> graph_t {
              check(equality, report(""), g.mutate_edge_weight(g.cbegin_edges(0), [](auto& w) { w -=  std::complex<float>{0.2f, -0.1f}; return 42; }), 42);
              return g;
            }
          },
           {
            ...
            report_line(""),
            [this](graph_t g) -> graph_t {
              check(equality, report(""), g.mutate_edge_weight(g.cbegin_edges(0) + 1, [](auto& w) { w -=  std::complex<float>{0.2f, -0.1f}; return 42; }), 42);
              return g;
            }
          },
          {
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}}});
          check(equality, report(""), g, graph_t{{edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}}}, nodes_init_t{{2.1, 1.1}});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}}},  nodes_init_t{{2.1, 1.1}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0}, edge_t{0}}}, nodes_init_t{{2.1, 1.1}});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{0}, edge_t{0}}},  nodes_init_t{{2.1, 1.1}}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0}, edge_t{0}, edge_t{0}, edge_t{0}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0}, edge_t{0}, edge_t{0}, edge_t{0}}}, nodes_init_t{{2.1, 1.1}});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{0}, edge_t{0}, edge_t{0}, edge_t{0}}}, nodes_init_t{{2.1, 1.1}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, -0.2f, 0.1f},  edge_t{0, -0.2f, 0.1f}, edge_t{0}, edge_t{0}}});
          check(equality, report(""), g, graph_t{{edge_t{0, -0.2f, 0.1f},  edge_t{0, -0.2f, 0.1f}, edge_t{0}, edge_t{0}}});
          check(equality, report(""), g, graph_t{{edge_t{0, -0.2f, 0.1f}, edge_t{0}, edge_t{0}, edge_t{0, -0.2f, 0.1f}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, -0.2f, 0.1f},  edge_t{0, -0.2f, 0.1f}, edge_t{0, 0.3f}, edge_t{0, 0.3f}}});
          check(equality, report(""), g, graph_t{{edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}, edge_t{0, 0.3f}, edge_t{0, 0.3f}}});
          check(equality, report(""), g, graph_t{{edge_t{0, -0.2f, 0.1f}, edge_t{0, 0.3f},  edge_t{0, -0.2f, 0.1f}, edge_t{0, 0.3f}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, 0.3f}, edge_t{0, 0.3f}, edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}}});
          check(equality, report(""), g, graph_t{{edge_t{0, 0.3f}, edge_t{0, 0.3f}, edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}}});
          check(equality, report(""), g, graph_t{{edge_t{0, 0.3f}, edge_t{0, 0.3f}, edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{}, {}}, nodes_init_t{{2.1, 1.1}, {-0.7}});
          check(equality, report(""), g, graph_t{edges_init_t{{}, {}},  nodes_init_t{{2.1, 1.1}, {-0.7}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{}, {}}, nodes_init_t{{-0.7}, {2.1, 1.1}});
          check(equality, report(""), g, graph_t{edges_init_t{{}, {}},  nodes_init_t{{-0.7}, {2.1, 1.1}}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{1, -0.2f, 0.1f}}, {edge_t{0, -0.2f, 0.1f}}});
          check(equality, report(""), g, graph_t{{edge_t{1, -0.2f, 0.1f}}, {edge_t{0, -0.2f, 0.1f}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{1, -0.2f, 0.1f}}, {edge_t{0, -0.2f, 0.1f}}}, nodes_init_t{{2.1, 1.1}, {}});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{1, -0.2f, 0.1f}}, {edge_t{0, -0.2f, 0.1f}}}, nodes_init_t{{2.1, 1.1}, {}}});
    ...
    transition_graph trg{
     {
       {  // begin 'graph_description::node_1_1_node_0_0'
         ...
         },
         {
            ...
            report_line(""),
            [this](graph_t g) -> graph_t {
              check(equality, report(""), g.mutate_edge_weight(g.cbegin_edges(1), [](auto& w) { w -=  std::complex<float>{0.2f, -0.1f}; return 42; }), 42);
              return g;
            }
         },
         {
         ...
         },
         {
            ...
            report_line(""),
            [this](graph_t g) -> graph_t {
              check(equality, report(""), g.mutate_edge_weight(g.cbegin_edges(1) + 1, [](auto& w) { w -=  std::complex<float>{0.2f, -0.1f}; return 42; }), 42);
              return g;
            }
         }
     ...
     },
     {
       ...
       [this]() -> graph_t {
         ...
         check(equivalence, report(""), g, edges_init_t{{edge_t{1}, edge_t{1}}, {edge_t{0}, edge_t{0}}});
       ...
       [this]() -> graph_t {
         ...
         check(equivalence, report(""), g, edges_init_t{{edge_t{1, -0.2f, 0.1f}, edge_t{1}}, {edge_t{0, -0.2f, 0.1f}, edge_t{0}}});
         check(equality, report(""), g, graph_t{{edge_t{1, -0.2f, 0.1f}, edge_t{1}}, {edge_t{0, -0.2f, 0.1f}, edge_t{0}}});
    ...
    transition_graph trg{
      ...
      },
      {
         ...
         [this]() -> graph_t {
           ...
           check(equivalence, report(""), g, edges_init_t{{edge_t{1}, edge_t{2, 0.5f}}, {edge_t{0}, edge_t{2, -0.2f, 0.1f}}, {edge_t{0, 0.5f}, edge_t{1, -0.2f, 0.1f}}}, nodes_init_t{{2.1, 1.1}, {0.7}, {}});
           check(equality, report(""), g, graph_t{edges_init_t{{edge_t{1}, edge_t{2, 0.5f}}, {edge_t{0}, edge_t{2, -0.2f, 0.1f}}, {edge_t{0, 0.5f}, edge_t{1, -0.2f, 0.1f}}}, nodes_init_t{{2.1, 1.1}, {0.7}, {}}});
         ...
         [this]() -> graph_t {
           ...
           check(equivalence, report(""), g, edges_init_t{{edge_t{2, 0.5f}, edge_t{1, -0.2f, 0.1f}}, {edge_t{2}, edge_t{0, -0.2f, 0.1f}}, {edge_t{1}, edge_t{0, 0.5f}}}, nodes_init_t{{}, {0.7}, {2.1, 1.1}});
