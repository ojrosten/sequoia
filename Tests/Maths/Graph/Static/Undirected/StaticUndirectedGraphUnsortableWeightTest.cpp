    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, edges_init_t{{}}, nodes_init_t{{2.1, 1.1}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, edges_init_t{{edge_t{0, -0.2f, 0.1f}, edge_t{0, -0.2f, 0.1f}}}, nodes_init_t{{2.1, 1.1}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, edges_init_t{{edge_t{0}, edge_t{0}}}, nodes_init_t{{2.1, 1.1}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, edges_init_t{{edge_t{0}, edge_t{0}, edge_t{0}, edge_t{0}}}, nodes_init_t{{2.1, 1.1}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, edges_init_t{{}, {}}, nodes_init_t{{2.1, 1.1}, {-0.7}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, edges_init_t{{}, {}}, nodes_init_t{{-0.7}, {2.1, 1.1}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, edges_init_t{{edge_t{1, -0.2f, 0.1f}}, {edge_t{0, -0.2f, 0.1f}}}, nodes_init_t{{2.1, 1.1}, {}});
    ...
    transition_graph trg{
      ...
      },
      {
         ...
         [this]() -> graph_t {
           ...
           check(equivalence, "", g, edges_init_t{{edge_t{1}, edge_t{2, 0.5f}}, {edge_t{0}, edge_t{2, -0.2f, 0.1f}}, {edge_t{0, 0.5f}, edge_t{1, -0.2f, 0.1f}}}, nodes_init_t{{2.1, 1.1}, {0.7}, {}});
         ...
         [this]() -> graph_t {
           ...
           check(equivalence, "", g, edges_init_t{{edge_t{2, 0.5f}, edge_t{1, -0.2f, 0.1f}}, {edge_t{2}, edge_t{0, -0.2f, 0.1f}}, {edge_t{1}, edge_t{0, 0.5f}}}, nodes_init_t{{}, {0.7}, {2.1, 1.1}});
