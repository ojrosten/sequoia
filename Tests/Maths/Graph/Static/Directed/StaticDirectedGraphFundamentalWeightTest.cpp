    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, 0.2f}}});
          check(equality, report(""), g, graph_t{{edge_t{0, 0.2f}}});
    ...
    if constexpr(!std::is_empty_v<NodeWeight>)
    {
      ...
      trg.add_node(        
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, 0.2f}}}, nodes_init_t{2.1});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{0, 0.2f}}},  nodes_init_t{2.1}});
      ...
      trg.add_node(
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_t{0}}},  nodes_init_t{2.1}};

          check(equivalence, report(""), g, edges_init_t{{edge_t{0}}}, nodes_init_t{2.1});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{0}}},  nodes_init_t{2.1}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0}, edge_t{0}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0}, edge_t{0}}}, nodes_init_t{2.1});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{0}, edge_t{0}}}, nodes_init_t{2.1}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, 0.2f}, edge_t{0}}});
          check(equality, report(""), g, graph_t{{edge_t{0, 0.2f}, edge_t{0}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, 0.2f}, edge_t{0, 0.3f}}});
          check(equality, report(""), g, graph_t{{edge_t{0, 0.2f}, edge_t{0, 0.3f}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{0, 0.3f}, edge_t{0, 0.2f}}});
          check(equality, report(""), g, graph_t{{edge_t{0, 0.3f}, edge_t{0, 0.2f}}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{1}}, {}});
        ...
        // 'graph_description::node_1u_node'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_t{1, 0.2f}}, {}};
          check(equivalence, report(""), g, edges_init_t{{edge_t{1, 0.2f}}, {}});
          check(equality, report(""), g, graph_t{{edge_t{1, 0.2f}}, {}});
        ...
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_t{1, 0.2f}}, {}}, nodes_init_t{2.1, -0.7}};
          check(equivalence, report(""), g, edges_init_t{{edge_t{1, 0.2f}}, {}}, nodes_init_t{2.1, -0.7});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{1, 0.2f}}, {}}, nodes_init_t{2.1, -0.7}});
        ...
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{}, {edge_t{0, 0.2f}}}, nodes_init_t{-0.7, 2.1}};
          check(equivalence, report(""), g, edges_init_t{{}, {edge_t{0, 0.2f}}}, nodes_init_t{-0.7, 2.1});
          check(equality, report(""), g, graph_t{edges_init_t{{}, {edge_t{0, 0.2f}}}, nodes_init_t{-0.7, 2.1}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, report(""), g, edges_init_t{{edge_t{1}}, {edge_t{0}}});
        ...
        // 'graph_description::node_1_node_0u'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_t{1}}, {edge_t{0, 0.2f}}};
          check(equivalence, report(""), g, edges_init_t{{edge_t{1}}, {edge_t{0, 0.2f}}});
          check(equality, report(""), g, graph_t{{edge_t{1}}, {edge_t{0, 0.2f}}});
        ...
        // 'graph_description::node_1u_node_0'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_t{1, 0.2f}}, {edge_t{0}}};
          check(equivalence, report(""), g, edges_init_t{{edge_t{1, 0.2f}}, {edge_t{0}}});
          check(equality, report(""), g, graph_t{{edge_t{1, 0.2f}}, {edge_t{0}}});
        ...
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_t{1}}, {edge_t{0, 0.2f}}}, nodes_init_t{2.1, 0.0}};
          check(equivalence, report(""), g, edges_init_t{{edge_t{1}}, {edge_t{0, 0.2f}}}, nodes_init_t{2.1, 0.0});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{1}}, {edge_t{0, 0.2f}}}, nodes_init_t{2.1, 0.0}});
        ...
        // 'graph_description::node_1u_nodew_0'
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_t{1, 0.2f}}, {edge_t{0}}}, nodes_init_t{0.0, 2.1}};
          check(equivalence, report(""), g, edges_init_t{{edge_t{1, 0.2f}}, {edge_t{0}}}, nodes_init_t{0.0, 2.1});
          check(equality, report(""), g, graph_t{edges_init_t{{edge_t{1, 0.2f}}, {edge_t{0}}}, nodes_init_t{0.0, 2.1}});
  ...
  void static_directed_graph_fundamental_weight_test::test_node_1_node_2_node_0()
  {
    ...
    transition_graph trg{
      ...
      },
      {
         // 'graph_description::nodew_1_nodex_2u_node_0v'
         [this]() -> graph_t {
           constexpr graph_t g{edges_init_t{{edge_t{1}}, {edge_t{2, 0.2f}}, {edge_t{0, 0.5f}}}, nodes_init_t{2.1, 0.7, 0.0}};
           check(equivalence, report(""), g, edges_init_t{{edge_t{1}}, {edge_t{2, 0.2f}}, {edge_t{0, 0.5f}}}, nodes_init_t{2.1, 0.7, 0.0});
           check(equality, report(""), g, graph_t{edges_init_t{{edge_t{1}}, {edge_t{2, 0.2f}}, {edge_t{0, 0.5f}}}, nodes_init_t{2.1, 0.7, 0.0}});
         ...
         // 'graph_description::node_2v_nodex_0u_nodew_1'
         [this]() -> graph_t {
           constexpr graph_t g{edges_init_t{{edge_t{2, 0.5f}}, {edge_t{0, 0.2f}}, {edge_t{1}}}, nodes_init_t{0.0, 0.7, 2.1}};
           check(equivalence, report(""), g, edges_init_t{{edge_t{2, 0.5f}}, {edge_t{0, 0.2f}}, {edge_t{1}}}, nodes_init_t{0.0, 0.7, 2.1});
           check(equality, report(""), g, graph_t{edges_init_t{{edge_t{2, 0.5f}}, {edge_t{0, 0.2f}}, {edge_t{1}}}, nodes_init_t{0.0, 0.7, 2.1}});
