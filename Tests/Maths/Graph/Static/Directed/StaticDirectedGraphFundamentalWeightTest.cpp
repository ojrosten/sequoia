...
namespace sequoia::testing
{
  ...
  [[nodiscard]]
  std::filesystem::path static_directed_graph_fundamental_weight_test::source_file()
  {
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, std::pair{edges_init_t{{}}, nodes_init_t{2.1}});
          check(equality, "", g, graph_t{edges_init_t{{}},  nodes_init_t{2.1}});
  ...
  void static_directed_graph_fundamental_weight_test::test_node_0()
  {
    ...
    using graph_t = static_directed_graph<1, 1, EdgeWeight, NodeWeight>;
    using edge_init_t = graph_t::edge_init_type;
    using edges_init_t = std::initializer_list<std::initializer_list<edge_init_t>>;
    using transition_graph = transition_checker<graph_t>::transition_graph;

    check_exception_thrown<std::logic_error>("", [](){ graph_t{{edge_init_t{0}, edge_init_t{0}}}; });
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          constexpr graph_t g{{edge_init_t{0}}};
          check(equivalence, "", g, edges_init_t{{edge_init_t{0}}});
          check(equality, "", g, graph_t{{edge_init_t{0}}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, edges_init_t{{edge_init_t{0, 0.2f}}});
          check(equality, "", g, graph_t{{edge_init_t{0, 0.2f}}});
    ...
    if constexpr(!std::is_empty_v<NodeWeight>)
    {
      ...
      trg.add_node(        
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_init_t{0, 0.2f}}},  nodes_init_t{2.1}};

          check(equivalence, "", g, std::pair{edges_init_t{{edge_init_t{0, 0.2f}}}, nodes_init_t{2.1}});
          check(equality, "", g, graph_t{edges_init_t{{edge_init_t{0, 0.2f}}},  nodes_init_t{2.1}});
      ...
      trg.add_node(
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_init_t{0}}},  nodes_init_t{2.1}};

          check(equivalence, "", g, std::pair{edges_init_t{{edge_init_t{0}}}, nodes_init_t{2.1}});
          check(equality, "", g, graph_t{edges_init_t{{edge_init_t{0}}},  nodes_init_t{2.1}});
  ...
  void static_directed_graph_fundamental_weight_test::test_node_0_0()
  {
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        // 'graph_description::node_0x_0'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_init_t{0, 0.2f}, edge_init_t{0}}};
          check(equivalence, "", g, edges_init_t{{edge_init_t{0, 0.2f}, edge_init_t{0}}});
          check(equality, "", g, graph_t{{edge_init_t{0, 0.2f}, edge_init_t{0}}});
        ...
        // 'graph_description::node_0x_0y'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_init_t{0, 0.2f}, edge_init_t{0, 0.3f}}};
          check(equivalence, "", g, edges_init_t{{edge_init_t{0, 0.2f}, edge_init_t{0, 0.3f}}});
          check(equality, "", g, graph_t{{edge_init_t{0, 0.2f}, edge_init_t{0, 0.3f}}});
        ...
        // 'graph_description::node_0y_0x'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_init_t{0, 0.3f}, edge_init_t{0, 0.2f}}};
          check(equivalence, "", g, edges_init_t{{edge_init_t{0, 0.3f}, edge_init_t{0, 0.2f}}});
          check(equality, "", g, graph_t{{edge_init_t{0, 0.3f}, edge_init_t{0, 0.2f}}});
    ...
    transition_graph trg{
      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, std::pair{edges_init_t{{}, {}}, nodes_init_t{2.1, 0.0}});
          check(equality, "", g, graph_t{edges_init_t{{}, {}},  nodes_init_t{2.1, 0.0}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, std::pair{edges_init_t{{}, {}}, nodes_init_t{2.1, -0.7}});
          check(equality, "", g, graph_t{edges_init_t{{}, {}},  nodes_init_t{2.1, -0.7}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence, "", g, std::pair{edges_init_t{{}, {}}, nodes_init_t{-0.7, 2.1}});
          check(equality, "", g, graph_t{edges_init_t{{}, {}},  nodes_init_t{ -0.7, 2.1}});
  ...
  {
    enum graph_description { node_1_node = 0, node_1u_node, node_node_0u, nodew_1u_nodex, nodex_nodew_0u };
    ...
    check_exception_thrown<std::logic_error>("", [](){ graph_t{{}}; });
    check_exception_thrown<std::logic_error>("", [](){ graph_t{{edge_init_t{1}}}; });
    check_exception_thrown<std::logic_error>("", [](){ graph_t{{edge_init_t{1}}, {}, {}}; });
    ...
    transition_graph trg{
      {
        ...
        {  // begin 'graph_description::node_1u_node'
          {
        ...
        }, // end 'graph_description::node_1u_node'
        {  // begin 'graph_description::node_node_0u'
          {
            graph_description::node_1u_node,
            report(""),
            [](graph_t g) -> graph_t {
        ...
        }, // end 'graph_description::node_node_0u'
        {  // begin 'graph_description::nodew_1u_nodex'
        }, // end 'graph_description::nodew_1u_nodex'
        {  // begin 'graph_description::nodex_nodew_0u'
        }  // end 'graph_description::nodex_nodew_0u'
      },
      {
        // 'graph_description::node_1_node'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_init_t{1}}, {}};
          check(equivalence, "", g, edges_init_t{{edge_init_t{1}}, {}});
          check(equality, "", g, graph_t{{edge_init_t{1}}, {}});
        ...
        // 'graph_description::node_1u_node'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_init_t{1, 0.2f}}, {}};
          check(equivalence, "", g, edges_init_t{{edge_init_t{1, 0.2f}}, {}});
          check(equality, "", g, graph_t{{edge_init_t{1, 0.2f}}, {}});
        ...
        // 'graph_description::nodew_1u_nodex'
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_init_t{1, 0.2f}}, {}}, nodes_init_t{2.1, -0.7}};
          check(equivalence, "", g, std::pair{edges_init_t{{edge_init_t{1, 0.2f}}, {}}, nodes_init_t{2.1, -0.7}});
          check(equality, "", g, graph_t{edges_init_t{{edge_init_t{1, 0.2f}}, {}}, nodes_init_t{2.1, -0.7}});

          return g;
        },

        // 'graph_description::nodex_nodew_0u'
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{}, {edge_init_t{0, 0.2f}}}, nodes_init_t{-0.7, 2.1}};
          check(equivalence, "", g, std::pair{edges_init_t{{}, {edge_init_t{0, 0.2f}}}, nodes_init_t{-0.7, 2.1}});
          check(equality, "", g, graph_t{edges_init_t{{}, {edge_init_t{0, 0.2f}}}, nodes_init_t{-0.7, 2.1}});
  ...
  {
    enum graph_description { node_1_node_0 = 0, node_1_node_0u, node_1u_node_0, nodew_1_node_0u, node_1u_nodew_0 };
    ...
    transition_graph trg{
      {
        ...
        {  // begin 'graph_description::node_1_node_0u'
          {
            graph_description::node_1u_node_0,
            report(""),
            [](graph_t g) -> graph_t {
        ...
        }, // end 'graph_description::node_1_node_0u'
        {  // begin 'graph_description::node_1u_node_0'
          {
            graph_description::node_1_node_0u,
            report(""),
            [](graph_t g) -> graph_t {
        ...
        }, // end 'graph_description::node_1u_node_0'
        {  // begin 'graph_description::nodew_1_node_0u'
           {
        ...
        }, // end 'graph_description::nodew_1_node_0u'
        {  // begin 'graph_description::node_1u_nodew_0'
        }  // end 'graph_description::node_1u_nodew_0'
      },
      {
        ...
        // 'graph_description::node_1_node_0u'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_init_t{1}}, {edge_init_t{0, 0.2f}}};
          check(equivalence, "", g, edges_init_t{{edge_init_t{1}}, {edge_init_t{0, 0.2f}}});
          check(equality, "", g, graph_t{{edge_init_t{1}}, {edge_init_t{0, 0.2f}}});
        ...
        // 'graph_description::node_1u_node_0'
        [this]() -> graph_t {
          constexpr graph_t g{{edge_init_t{1, 0.2f}}, {edge_init_t{0}}};
          check(equivalence, "", g, edges_init_t{{edge_init_t{1, 0.2f}}, {edge_init_t{0}}});
          check(equality, "", g, graph_t{{edge_init_t{1, 0.2f}}, {edge_init_t{0}}});

          return g;
        },

        // 'graph_description::nodew_1_node_0u'
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_init_t{1}}, {edge_init_t{0, 0.2f}}}, nodes_init_t{2.1, 0.0}};
          check(equivalence, "", g, std::pair{edges_init_t{{edge_init_t{1}}, {edge_init_t{0, 0.2f}}}, nodes_init_t{2.1, 0.0}});
          check(equality, "", g, graph_t{edges_init_t{{edge_init_t{1}}, {edge_init_t{0, 0.2f}}}, nodes_init_t{2.1, 0.0}});
        ...
        // 'graph_description::node_1u_nodew_0'
        [this]() -> graph_t {
          constexpr graph_t g{edges_init_t{{edge_init_t{1, 0.2f}}, {edge_init_t{0}}}, nodes_init_t{0.0, 2.1}};
          check(equivalence, "", g, std::pair{edges_init_t{{edge_init_t{1, 0.2f}}, {edge_init_t{0}}}, nodes_init_t{0.0, 2.1}});
          check(equality, "", g, graph_t{edges_init_t{{edge_init_t{1, 0.2f}}, {edge_init_t{0}}}, nodes_init_t{0.0, 2.1}});
  ...
  void static_directed_graph_fundamental_weight_test::test_node_1_node_2_node_0()
  {
    ...
    transition_graph trg{
      ...
      },
      {
         // 'graph_description::nodew_1_nodex_2u_node_0v'
         [this]() -> graph_t {
           constexpr graph_t g{edges_init_t{{edge_init_t{1}}, {edge_init_t{2, 0.2f}}, {edge_init_t{0, 0.5f}}}, nodes_init_t{2.1, 0.7, 0.0}};
           check(equivalence, "", g, std::pair{edges_init_t{{edge_init_t{1}}, {edge_init_t{2, 0.2f}}, {edge_init_t{0, 0.5f}}}, nodes_init_t{2.1, 0.7, 0.0}});
           check(equality, "", g, graph_t{edges_init_t{{edge_init_t{1}}, {edge_init_t{2, 0.2f}}, {edge_init_t{0, 0.5f}}}, nodes_init_t{2.1, 0.7, 0.0}});
         ...
         // 'graph_description::node_2v_nodex_0u_nodew_1'
         [this]() -> graph_t {
           constexpr graph_t g{edges_init_t{{edge_init_t{2, 0.5f}}, {edge_init_t{0, 0.2f}}, {edge_init_t{1}}}, nodes_init_t{0.0, 0.7, 2.1}};
           check(equivalence, "", g, std::pair{edges_init_t{{edge_init_t{2, 0.5f}}, {edge_init_t{0, 0.2f}}, {edge_init_t{1}}}, nodes_init_t{0.0, 0.7, 2.1}});
           check(equality, "", g, graph_t{edges_init_t{{edge_init_t{2, 0.5f}}, {edge_init_t{0, 0.2f}}, {edge_init_t{1}}}, nodes_init_t{0.0, 0.7, 2.1}});
