      ...
      },
      {
        ...
        [this]() -> graph_t {
          ...
          check(equivalence,
                "",
                g,
                std::pair{edges_init_t{{edge_init_t{1}}, {edge_init_t{0, 0.2f}}}, nodes_init_t{2.1, 0.0}});
          check(equality,
                "",
                g,
                graph_t{edges_init_t{{edge_init_t{1}}, {edge_init_t{0, 0.2f}}}, nodes_init_t{2.1, 0.0}});
        ...
        [this]() -> graph_t {
          ...
          check(equivalence,
                "",
                g,
                std::pair{edges_init_t{{edge_init_t{1, 0.2f}}, {edge_init_t{0}}}, nodes_init_t{0.0, 2.1}});
          check(equality,
                "",
                g,
                graph_t{edges_init_t{{edge_init_t{1, 0.2f}}, {edge_init_t{0}}}, nodes_init_t{0.0, 2.1}});
