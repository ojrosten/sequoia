...
namespace sequoia::testing
{
  ...
  void static_directed_graph_unweighted_test::test_constexpr_copy_assignment()
  {
    ...
    STATIC_CHECK((
      [](){
        ...
        graph_t g{{edge_init_t{1}}, {edge_init_t{0}}}, h{{edge_init_t{0}}, {edge_init_t{1}}};
        if(h == g) return false;
  ...
  void static_directed_graph_unweighted_test::test_node_0()
  {
    ...
    check(equivalence, "", g, edges_equivalent_t{{edge_init_t{0}}});
  ...
  void static_directed_graph_unweighted_test::test_node_0_0()
  {
    ...
    check(equivalence, "", g, edges_equivalent_t{{edge_init_t{0}, edge_init_t{0}}});
  ...
  void static_directed_graph_unweighted_test::test_node_1_node()
  {
    ...
    check(equivalence, "", g, edges_equivalent_t{{edge_init_t{1}}, {}});
  ...
  void static_directed_graph_unweighted_test::test_node_1_node_0()
  {
    ...
    check(equivalence, "", g, edges_equivalent_t{{edge_init_t{1}}, {edge_init_t{0}}});
