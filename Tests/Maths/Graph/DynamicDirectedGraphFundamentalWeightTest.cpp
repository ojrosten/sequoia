...
namespace sequoia::testing
{
  ...
  void dynamic_directed_graph_fundamental_weight_test::run_tests()
  {
    ...
    graph_test_helper<double, double, dynamic_directed_graph_fundamental_weight_test> helper{*this};
  ...
  >
  void dynamic_directed_graph_fundamental_weight_test::execute_operations()
  {
