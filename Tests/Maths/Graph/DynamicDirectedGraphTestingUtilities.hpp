...
namespace sequoia::testing
{
  ...
  enum directed_graph_description : std::size_t {
    empty = 0,
      ...
      return transition_graph{
        {
          ...
          {  // begin 'node_0'
            ...
            {
              directed_graph_description::node_0_0,
          ...
          {  // begin 'node_node'
            ...
            {
              directed_graph_description::node_1_node,
          ...
          {  // begin 'node_1_node'
            ...
            {
              directed_graph_description::node_0_1_node,
            ...
            {
              directed_graph_description::node_node_0,
            ...
            {
              directed_graph_description::node_1_1_node,
          ...
          {  // begin node_node_0
            ...
            {
              directed_graph_description::node_1_node_0,
              report_line("Join nodes {0,1}"),
              [](graph_t g) {
                g.join(0, 1);
                return g;
          ...
          {  // begin 'node_node_node'
            ...
            {
              directed_graph_description::node_1_node_node,
              report_line("Join {0,1}"),
              [](graph_t g) -> graph_t {
                g.join(0,1);
                return g;
            ...
            {
              directed_graph_description::node_node_node_1,
          ...
          {  // begin 'node_1_node_node'
            ...
            {
              directed_graph_description::node_node_node,
            ...
            {
              directed_graph_description::node_1_node_2_node,
              report_line("Join {2,1}"),
              [](graph_t g) -> graph_t {
                g.join(1,2);
                return g;
            ...
            {
              directed_graph_description::node_1_node_node_1,
              report_line("Join {2,1}"),
              [](graph_t g) -> graph_t {
                g.join(2,1);
                return g;
          ...
          {  // begin 'node_1_node_1_node'
            ...
            {
              directed_graph_description::node_1_node_1_0_node,
          ...
          {  // begin 'node_1_node_1_0_node'
            ...
            {
              directed_graph_description::node_1_node_1_node,
            ...
            {
              directed_graph_description::node_1_node_1_0_2_node,
          ...
          {  // begin 'node_1_node_1_0_2_node'
            ...
            {
              directed_graph_description::node_1_node_1_2_node,
              report_line("Remove {1,0}"),
              [](graph_t g) -> graph_t {
                g.erase_edge(++g.cbegin_edges(1));
                return g;
          ...
          {  // begin 'node_1_1_2_2_node_2_node'
            ...
            {
              directed_graph_description::node_1_1_2_2_node_2_node_1,
              report_line("Join {2, 1}"),
              [](graph_t g) -> graph_t {
                g.join(2,1);
                return g;
          ...
          {  // begin 'node_1_1_2_2_node_2_node_1'
            ...
            {
              directed_graph_description::node_2_2_1_1_node_2_node_1,
              report_line("Swap {1,2}"),
              [](graph_t g) -> graph_t {
                g.swap_nodes(1,2);
                return g;
            ...
            {
              directed_graph_description::node_2_2_1_1_node_2_node_1,
              report_line("Swap node 0 edges: {0,2}, {1,3}"),
              [](graph_t g) -> graph_t {
                g.swap_edges(0, 0, 2);
                g.swap_edges(0, 1, 3);
                return g;
          ...
          {  // begin 'node_2_2_1_1_node_2_node_1'
            ...
            {
              directed_graph_description::node_1_1_2_2_node_2_node_1,
              report_line("Sort Edges for node 0"),
              [](graph_t g) -> graph_t {
          ...
          {  // begin 'node_1_node_node_node_2'
            {
              directed_graph_description::node_2_node_node_node_1,
              report_line("Swap {2,1}"),
              [](graph_t g) -> graph_t {
                g.swap_nodes(2,1);
                return g;
          ...
          {  // begin 'node_2_node_node_node_1'
            {
              directed_graph_description::node_1_node_node_node_2,
              report_line("Swap {2,1}"),
              [](graph_t g) -> graph_t {
                g.swap_nodes(2,1);
                return g;
