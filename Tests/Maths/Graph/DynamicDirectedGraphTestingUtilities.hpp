...
namespace sequoia::testing
{
  ...
  template
  <
    maths::graph_flavour GraphFlavour, // TO DO: remove this template argument
    class EdgeWeight,
    class NodeWeight,
  ...
  {
    using graph_to_test      = maths::graph<maths::directed_flavour::directed, EdgeWeight, NodeWeight, EdgeWeightCreator, NodeWeightCreator, EdgeStorageTraits, NodeWeightStorageTraits>;
