...
namespace sequoia::testing
{
  ...
  void dynamic_undirected_embedded_graph_fundamental_weight_contiguous_test::run_tests()
  {
    ...
    dynamic_undirected_embedded_graph_weighted_operations<double, double, independent_contiguous_edge_storage_config, node_weight_storage_config<double>>::execute_operations(*this);
  }
}