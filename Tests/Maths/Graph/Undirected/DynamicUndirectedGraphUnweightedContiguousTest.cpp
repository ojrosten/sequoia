...
namespace sequoia::testing
{
  ...
  void dynamic_undirected_graph_unweighted_contiguous_test::run_tests()
  {
    ...
    dynamic_undirected_graph_operations<null_weight, null_weight, independent_contiguous_edge_storage_traits, node_weight_storage_traits<null_weight>>::execute_operations(*this);
  }
}