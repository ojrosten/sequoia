...
namespace sequoia::testing
{
  ...
  void dynamic_undirected_graph_shared_fundamental_weight_test::run_tests()
  {
    ...
    dynamic_undirected_graph_weighted_operations<double, double, shared_weight_bucketed_edge_storage_config, node_weight_storage_config<double>>::execute_operations(*this);
  }
}